...
<h3>SharedCount <a href="index.php?/plugin/sharedcount_refresh" id="dashboard_sharedcount_reload"><span class="icon-clock" style="float:right;"></span><span class="visuallyhidden">Reload</span></a></h3>
<script>
